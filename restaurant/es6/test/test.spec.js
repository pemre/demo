...
let RestaurantService = require(path.join(__dirname, '../src/js/services', 'restaurant.service'));
...
describe('Restaurant Service', () => {
    describe('filterRestaurants()', () => {
        ...
        it('returns all results without filterBy param', () => {
            (r.filterRestaurants(restaurants).length).should.equal(restaurants.length);
        });
    });
});
